...
2. Compares the bundled version (in `ha-raumkernel-addon/integration/`) with the installed version.
...
- `ha-raumkernel-addon/integration/`: Bundled integration files (generated by `prepare-build.sh`).
